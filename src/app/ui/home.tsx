        ...
        <section id={id} className={className}>
            <div className='block lg:absolute flex justify-center h-full w-full z-10'>
              <div className='absolute mx-auto h-1/2 top-0 overflow-hidden lg:right-0 lg:h-full lg:w-1/2'>
                <img className="w-full h-full object-cover object-top" src="developer.png" alt="Developer coding on labtop" />
              </div>
            </div>
            ...
            <div className="flex flex-col justify-start mx-auto lg:mx-0 lg:justify-center h-screen w-[90%] lg:pl-[10%] gap-4 z-20 lg:w-[730px]">
                ...
                <h1 className="text-6xl text-center mx-auto lg:mx-0 lg:text-start w-[300px] lg:w-full font-medium text-transparent bg-clip-text bg-gradient-to-r from-dark-900 to-dark-800">Nattakorn Khunart</h1>
                <span className="text-3xl mx-auto lg:mx-0 font-normal text-dark-50"> {'<Full stack Developer />'} </span>
                <p className="text-xl text-dark-300 text-center mx-auto lg:mx-0 lg:text-start max-w-[490px]">
                    <span>

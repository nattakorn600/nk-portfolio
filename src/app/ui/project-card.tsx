...
export default function ProjectCard({
    ...
    return (
        <div className={`relative group overflow-hidden ${className}`}>
            <img src={data.img} className="absolute text-wrap transition-all duration-300 ease-in-out w-full h-full object-cover group-hover:scale-110"/>
            ...
            <div className='absolute flex flex-col px-8 py-4 gap-4 mx-auto w-full h-full'>
                <h3 className="text-xl text-center font-normal text-transparent bg-clip-text bg-gradient-to-r from-dark-900 to-dark-800 opacity-0 transition-all translate-y-[20px] duration-300 group-hover:translate-y-0 group-hover:opacity-100 group-hover:delay-250">{data.title}</h3>
                <p className="text-base font-normal text-dark-950 opacity-0 transition-all translate-y-[20px] duration-300 group-hover:translate-y-0 group-hover:opacity-100 group-hover:delay-200">
                    ...
                    {data.youtube !== undefined && (
                        <a className="relative flex group/button" target="_blank" href={data.youtube}>
                            ...
                            <div className='absolute flex justify-center items-center bg-[#E40818] rounded w-[120px] h-[32px] rotate-0 transition-all duration-150 translate-y-0 group-hover/button:translate-y-[-5px] group-hover/button:rotate-[2deg]'>
                                <Image height={24} width={24} src="youtube.svg" alt={`Youtube video project content: ${data.title}`} />
                    ...
                    {data.github !== undefined && (
                        <a className="relative flex group/button" target="_blank" href={data.github}>
                            ...
                            <div className='absolute flex justify-center items-center bg-[#333539] rounded w-[120px] h-[32px] rotate-0 transition-all duration-150 translate-y-0 group-hover/button:translate-y-[-5px] group-hover/button:rotate-[2deg]'>
                                <Image height={24} width={24} src="github.svg" alt={`Github source project: ${data.title}`} />

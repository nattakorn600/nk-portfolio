...
export default function ProjectsPage({
    ...
    return (
        <section id={id} className={className}>
            ...
            <hr className="w-3/5 h-[2px] mx-auto my-4 border-0 rounded bg-dark-300 mt-20"></hr>
            <h2 className="text-4xl md:text-5xl text-dark-300 drop-shadow-lg">My Project</h2>
            <hr className="w-3/5 h-[2px] mx-auto my-4 border-0 rounded bg-dark-300"></hr>

    ...
    return (
        <section id={id} className={className}>
            ...
            <div className="flex w-full justify-center items-center mt-16 md:mt-24">
                <h2 className='text-4xl md:text-5xl text-dark-300 drop-shadow-lg'>My Skills</h2>
            </div>

            <div className="flex flex-wrap w-3/4 md:w-3/5 h-full justify-center items-center gap-10 md:gap-12 my-16 md:my-32">
